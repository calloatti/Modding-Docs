...
# Your output repository for the main branch
...
# APPLIED EXPERIMENTAL CHANGE: Filter to only decompile game-specific and engine-specific assemblies
...
# FIX: Target path updated to use timberborn_main
Copy-Item -Path "C:\Program Files (x86)\Steam\steamapps\common\timberborn_main\Timberborn_Data\StreamingAssets\Version.txt" -Destination (Join-Path $outputRoot "_version.txt")
