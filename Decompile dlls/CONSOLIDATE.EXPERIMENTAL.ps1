# CONFIGURATION
$SourcePath = Join-Path (Get-Location) "DECOMPILED.EXPERIMENTAL.TEMP"
$OutputDirectory = Join-Path (Get-Location) "DECOMPILED.EXPERIMENTAL"
$FileExtension = "*.cs"
...
Copy-Item -Path "C:\Program Files (x86)\Steam\steamapps\common\Timberborn\Timberborn_Data\StreamingAssets\Version.txt" -Destination "C:\Users\calloatti\Documents\Timberborn\Mods.Modding\DECOMPILED.EXPERIMENTAL\_Version.txt"